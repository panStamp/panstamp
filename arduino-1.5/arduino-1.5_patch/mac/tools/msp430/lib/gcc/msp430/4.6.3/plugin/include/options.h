...
#endif
#ifdef GENERATOR_FILE
extern const char *msp430_opt_cpu;
#else
  const char *x_msp430_opt_cpu;
#define msp430_opt_cpu global_options.x_msp430_opt_cpu
#endif
#ifdef GENERATOR_FILE
extern int msp430_disable_watchdog;
#else
  int x_msp430_disable_watchdog;
#define msp430_disable_watchdog global_options.x_msp430_disable_watchdog
#endif
#ifdef GENERATOR_FILE
extern int msp430_enable_libcall_shift;
#else
  int x_msp430_enable_libcall_shift;
#define msp430_enable_libcall_shift global_options.x_msp430_enable_libcall_shift
#endif
#ifdef GENERATOR_FILE
extern const char *msp430_opt_ivcnt;
#else
  const char *x_msp430_opt_ivcnt;
#define msp430_opt_ivcnt global_options.x_msp430_opt_ivcnt
#endif
#ifdef GENERATOR_FILE
extern const char *msp430_mcu_name;
#else
  const char *x_msp430_mcu_name;
#define msp430_mcu_name global_options.x_msp430_mcu_name
#endif
#ifdef GENERATOR_FILE
extern const char *msp430_opt_mpy;
#else
  const char *x_msp430_opt_mpy;
#define msp430_opt_mpy global_options.x_msp430_opt_mpy
#endif
#ifdef GENERATOR_FILE
...
#define MASK_NO_HWMUL (1 << 0)
#define MASK_INLINESIHWMUL (1 << 1)
#define MASK_NVWA (1 << 2)
#define MASK_NOINT_HWMUL (1 << 3)
#define MASK_SAVE_PROLOGUE (1 << 4)

#define TARGET_NO_HWMUL ((target_flags & MASK_NO_HWMUL) != 0)
#define TARGET_INLINESIHWMUL ((target_flags & MASK_INLINESIHWMUL) != 0)
#define TARGET_NVWA ((target_flags & MASK_NVWA) != 0)
#define TARGET_NOINT_HWMUL ((target_flags & MASK_NOINT_HWMUL) != 0)
#define TARGET_SAVE_PROLOGUE ((target_flags & MASK_SAVE_PROLOGUE) != 0)
...
enum opt_code
{
  ...
  OPT_mcpu_ = 941,                           /* -mcpu= */
  OPT_mdisable_hwmul = 942,                  /* -mdisable-hwmul */
  OPT_mdisable_watchdog = 943,               /* -mdisable-watchdog */
  OPT_menable_libcall_shift = 944,           /* -menable-libcall-shift */
  OPT_minline_hwmul = 945,                   /* -minline-hwmul */
  OPT_mivcnt_ = 946,                         /* -mivcnt= */
  OPT_mmcu_ = 947,                           /* -mmcu= */
  OPT_mmpy_ = 948,                           /* -mmpy= */
  OPT_mno_volatile_workaround = 949,         /* -mno-volatile-workaround */
  OPT_mnoint_hwmul = 950,                    /* -mnoint-hwmul */
  OPT_msave_prologue = 951,                  /* -msave-prologue */
  OPT_n = 952,                               /* -n */
  OPT_no_canonical_prefixes = 953,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 954,               /* -no-integrated-cpp */
  OPT_nocpp = 955,                           /* -nocpp */
  OPT_nodefaultlibs = 956,                   /* -nodefaultlibs */
  OPT_nostartfiles = 957,                    /* -nostartfiles */
  OPT_nostdinc = 958,                        /* -nostdinc */
  OPT_nostdinc__ = 959,                      /* -nostdinc++ */
  OPT_nostdlib = 960,                        /* -nostdlib */
  OPT_o = 961,                               /* -o */
  OPT_p = 962,                               /* -p */
  OPT_pass_exit_codes = 963,                 /* -pass-exit-codes */
  OPT_pedantic = 964,                        /* -pedantic */
  OPT_pedantic_errors = 965,                 /* -pedantic-errors */
  OPT_pg = 966,                              /* -pg */
  OPT_pie = 967,                             /* -pie */
  OPT_pipe = 968,                            /* -pipe */
  OPT_print_file_name_ = 969,                /* -print-file-name= */
  OPT_print_libgcc_file_name = 970,          /* -print-libgcc-file-name */
  OPT_print_multi_directory = 971,           /* -print-multi-directory */
  OPT_print_multi_lib = 972,                 /* -print-multi-lib */
  OPT_print_multi_os_directory = 973,        /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 974,         /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 975,                /* -print-prog-name= */
  OPT_print_search_dirs = 976,               /* -print-search-dirs */
  OPT_print_sysroot = 977,                   /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 978,    /* -print-sysroot-headers-suffix */
  OPT_quiet = 979,                           /* -quiet */
  OPT_r = 980,                               /* -r */
  OPT_remap = 981,                           /* -remap */
  OPT_s = 982,                               /* -s */
  OPT_s_bc_abi = 983,                        /* -s-bc-abi */
  OPT_save_temps = 984,                      /* -save-temps */
  OPT_save_temps_ = 985,                     /* -save-temps= */
  OPT_shared = 986,                          /* -shared */
  OPT_shared_libgcc = 987,                   /* -shared-libgcc */
  /* OPT_specs = 988, */                     /* -specs */
  OPT_specs_ = 989,                          /* -specs= */
  OPT_static = 990,                          /* -static */
  OPT_static_libgcc = 991,                   /* -static-libgcc */
  OPT_static_libgcj = 992,                   /* -static-libgcj */
  OPT_static_libgfortran = 993,              /* -static-libgfortran */
  OPT_static_libgo = 994,                    /* -static-libgo */
  OPT_static_libstdc__ = 995,                /* -static-libstdc++ */
  /* OPT_std_c__03 = 996, */                 /* -std=c++03 */
  OPT_std_c__0x = 997,                       /* -std=c++0x */
  OPT_std_c__98 = 998,                       /* -std=c++98 */
  OPT_std_c1x = 999,                         /* -std=c1x */
  /* OPT_std_c89 = 1000, */                  /* -std=c89 */
  OPT_std_c90 = 1001,                        /* -std=c90 */
  OPT_std_c99 = 1002,                        /* -std=c99 */
  /* OPT_std_c9x = 1003, */                  /* -std=c9x */
  OPT_std_f2003 = 1004,                      /* -std=f2003 */
  OPT_std_f2008 = 1005,                      /* -std=f2008 */
  OPT_std_f95 = 1006,                        /* -std=f95 */
  OPT_std_gnu = 1007,                        /* -std=gnu */
  OPT_std_gnu__0x = 1008,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1009,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1010,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1011, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1012,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1013,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1014, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1015, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1016,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1017, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1018, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1019,                     /* -std=legacy */
  OPT_symbolic = 1020,                       /* -symbolic */
  OPT_t = 1021,                              /* -t */
  OPT_time = 1022,                           /* -time */
  OPT_time_ = 1023,                          /* -time= */
  OPT_traditional = 1024,                    /* -traditional */
  OPT_traditional_cpp = 1025,                /* -traditional-cpp */
  OPT_trigraphs = 1026,                      /* -trigraphs */
  OPT_u = 1027,                              /* -u */
  OPT_undef = 1028,                          /* -undef */
  OPT_v = 1029,                              /* -v */
  OPT_version = 1030,                        /* -version */
  OPT_w = 1031,                              /* -w */
  OPT_wrapper = 1032,                        /* -wrapper */
  OPT_x = 1033,                              /* -x */
  OPT_z = 1034,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
